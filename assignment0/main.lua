...
function love.load()
    ...
    -- initialize player roles as nil
    player1Role = nil
    player2Role = nil
    ...
    -- variable to store ball's starting x velocity
    ballStartingdx = 0
    ...
    -- 1. 'setup' (players choose whether they are a player or AI)
...
function love.update(dt)
    ...
    if player1.isAI then
        -- AI responds to ball location if ball is moving towards them
...
function love.keypressed(key)
    ...
    -- if we press backspace return to setup phase and reset all game components
    ...
    elseif gameState == 'setup'then
        if key == 'w' and not player1Role then
            player1.isAI = false
            player1Role = 'Player 1 is a Player'
            if player2Role then
                gameState = 'start'
            end
        ...
        elseif key == 'up' and not player2Role then
            player2.isAI = false
            player2Role = 'Player 2 is a Player'
            if player1Role then
                gameState = 'start'
            end
...
function love.draw()
    ...
    if gameState == 'setup' then
        ...
        love.graphics.printf('Please choose player type!', 0, 20, VIRTUAL_WIDTH, 'center')
        ...
        if player1Role then
            ...
            love.graphics.printf('Player', 0, 100, VIRTUAL_WIDTH/2, 'center')
            love.graphics.printf('S', 0, 150, VIRTUAL_WIDTH/2, 'center')
            love.graphics.printf('AI', 0, 160, VIRTUAL_WIDTH/2, 'center')
            love.graphics.setFont(largeFont)
            love.graphics.printf('Player1', 0, 50, VIRTUAL_WIDTH/2, 'center')
        end
        ...
        if player2Role then
            ...
            love.graphics.printf('Player', VIRTUAL_WIDTH/2, 100, VIRTUAL_WIDTH/2, 'center')
            ...
            love.graphics.setFont(largeFont)
            love.graphics.printf('Player2', VIRTUAL_WIDTH/2, 50, VIRTUAL_WIDTH/2, 'center')
        end
    elseif gameState == 'start' then
        ...
        love.graphics.printf('Press Backspace to return to player selection!', 0, 30, VIRTUAL_WIDTH, 'center')
        love.graphics.printf(player1Role, 0, 50, VIRTUAL_WIDTH/2, 'center')
        love.graphics.printf(player2Role, VIRTUAL_WIDTH/2, 50, VIRTUAL_WIDTH/2, 'center')
